# 📋 任务看板
 ...
 > 每次工作前看这里；每次完成后更新这里。最后更新：2026-08-24（IT-014 开启）

## 当前位置

- **宏观**：M5 发布准备 —— ✅ 完成（IT-008：本地 dist + tag v0.1.0；PyPI 后续）
- **微观**：IT-016 覆盖率+live 扩域 ✅（2026-08-24；src 91.4% + 90% 门禁；
  examples 73%→91%；live 11 用例对真实 1.18.22 全过、零漂移；顺带修
  mcp_servers --oauth 不可达 与 interact 轮询竞态两个示例 bug）
